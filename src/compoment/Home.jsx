...
const Home = () => {
  return (
    <div className='px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py20 flex flex-col items-center justify-between lg:flex-row'>
      {/* Text Content */}
